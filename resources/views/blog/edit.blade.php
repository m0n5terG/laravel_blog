...
@if ($errors->any())
    <div class="w-4/5 m-auto">
        <ul>
            ...
            <li clsss="w-1/5 mb-4 text gray-50 bg-red-700 rounded-2xl py-4">
                {{ $error }}
            </li>
            @endforeach
        </ul>
...
<div class="w-4/5 m-auto pt-20">
    <form 
        ...
        <textarea 
            ...
            class="py-20 bg-transparent block border-b-2 w-full h-60 text-lg outline-none">{{ $post->description }}</textarea>
